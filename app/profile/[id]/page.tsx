...
export default function UserProfilePage() {
  ...
  // Assuming 'upvotedBy' is the field for profile upvotes based on schema
  ...
  const loadingPortfolio = false; // Placeholder
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <Container className="pt-24 pb-20">
        ...
        >
             {/* Background Image - User Requested "Splash Loading Screen.jpg" */}
             ...
             <div className="relative z-10 p-8 flex flex-col md:flex-row justify-between items-end gap-6">
                <div className="flex items-end gap-6 translate-y-8 md:translate-y-12">
                    {/* Profile Image - User Requested "Group 34374.png" */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8 mb-16 mt-16">
                ...
                <div className="bg-[#1a1a1a] rounded-[30px] aspect-video w-full overflow-hidden relative flex items-center justify-center group">
                    {hasYoutube ? (
                       ...
                       />
                        ...
                        // Fallback to Image/Snapshot - User mentioned "Snapshot"
                       <div className="relative w-full h-full">
                           <Image 
                               src="/images/Splash Loading Screen.jpg" // Placeholder for snapshot (reused as requested contextually)
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* About Card - User requested specific image for "second card" logic (Screenshot 2025-06-13...) */}
