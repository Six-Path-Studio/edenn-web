            ...
            <Container className="pt-32 pb-20">
                ...
                <div className="mt-20">
                    <div className="flex flex-col items-center justify-center mb-12">
                        <h2 className="text-3xl md:text-5xl font-power text-white text-center mb-4">
                            Studio Portfolio
                        </h2>
                        <p className="text-white/40 text-center font-dm-sans max-w-xl mx-auto">
                            Explore studios, projects, and playable ideas in one place.
                        </p>
                    </div>
                        ...
                        {userGames.length === 0 && (profileUser.snapshots && profileUser.snapshots.length > 0) ? (
                            ...
                            userGames.length === 0 && (
                                <div className="col-span-full py-20 bg-[#111] rounded-[32px] border border-white/5 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-white/40 text-sm">Stay tuned for amazing work from this Studio.</p>
                                </div>
                            )
                        )}
                    </div>
