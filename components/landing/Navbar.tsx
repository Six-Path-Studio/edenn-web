      ...
      <Container className={`flex items-center justify-between py-4 relative pointer-events-auto z-101 transition-all duration-300 rounded-[32px] ${
        ...
        <div className="hidden md:flex items-center gap-6">
          <div className="relative dropdown-trigger">
            <button 
              className={`flex items-center gap-1 text-sm font-power font-normal transition-colors ${activeDropdown === 'home' ? 'text-[#EBCF61]' : 'text-accent'}`}
          ...
          <Link href="/studios" className={pathname === "/studios" ? "text-white font-power font-normal text-sm transition-colors" : "text-text-secondary hover:text-white transition-colors text-sm font-power font-normal"}>
            Studios
          </Link>
          <Link href="/games" className={pathname === "/games" ? "text-white font-power font-normal text-sm transition-colors" : "text-text-secondary hover:text-white transition-colors text-sm font-power font-normal"}>
            Games
          </Link>
          <Link href="/creators" className={pathname === "/creators" ? "text-white font-power font-normal text-sm transition-colors" : "text-text-secondary hover:text-white transition-colors text-sm font-power font-normal"}>
            Creators
          </Link>
